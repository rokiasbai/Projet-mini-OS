...
void init_syscall()
{
  // ajout de la fonction de traitement de l'appel systeme example
  add_syscall(NR_example, sys_example);
  // ajout de la fonction de traitement de l'appel systeme shutdown et write
...
{
  //on fait appel a console_putbytes 
